...
def load_for_ml_model():
    ...
    rtd_df['hour'] = rtd_df.loc[~rtd_df['dp_pt'].isna(), 'dp_pt'].dt.hour
    rtd_df['day'] = rtd_df['ar_pt'].dt.dayofweek
    rtd_df['day'] = rtd_df.loc[~rtd_df['dp_pt'].isna(), 'dp_pt'].dt.dayofweek
    ...
    return rtd_df.drop(columns=['ar_cancellations', 'ar_cancellation_time_delta',
                                'ar_on_time_3', 'ar_on_time_5', 'ar_fern_on_time_5',
                                'dp_cancellations', 'dp_cancellation_time_delta', 'f',
                                'dp_on_time_3', 'dp_on_time_5', 'dp_fern_on_time_5', 'ar_ct',
