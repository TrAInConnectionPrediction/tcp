...
def test_get_eva():
    assert stations.get_eva(name='Tübingen Hbf', date=datetime.datetime(2021, 1, 1)) == 8000141
    assert stations.get_eva(name='Köln Hbf', date=datetime.datetime(2021, 1, 1)) == 8000207
...
def test_get_name():
    assert stations.get_name(eva=8000141, date=datetime.datetime(2021, 1, 1)) == 'Tübingen Hbf'
    assert stations.get_name(eva=8000207, date=datetime.datetime(2021, 1, 1)) == 'Köln Hbf'

    assert stations.get_name(ds100='TT', date=datetime.datetime(2021, 1, 1)) == 'Tübingen Hbf'
    assert stations.get_name(ds100='KK', date=datetime.datetime(2021, 1, 1)) == 'Köln Hbf'
...
def test_get_ds100():
    ...
    assert stations.get_ds100(name='Tübingen Hbf', date=datetime.datetime(2021, 1, 1)) == 'TT'
    assert stations.get_ds100(name='Köln Hbf', date=datetime.datetime(2021, 1, 1)) == 'KK'
...
def test_get_location():
    ...
    np.testing.assert_allclose(locations.loc[('Tübingen Hbf', datetime.datetime(2021, 1, 1))], (9.055407, 48.515811))
    np.testing.assert_allclose(locations.loc[('Köln Hbf', datetime.datetime(2021, 1, 1))], (6.958729, 50.943030))
    ...
    assert locations['lat'].dtype == np.float64
    assert locations['lon'].dtype == np.float64
    np.testing.assert_allclose(locations.loc[(8000141, datetime.datetime(2021, 1, 1))], (9.055407, 48.515811))
    np.testing.assert_allclose(locations.loc[(8000207, datetime.datetime(2021, 1, 1))], (6.958729, 50.943030))
    ...
    assert locations['lat'].dtype == np.float64
    assert locations['lon'].dtype == np.float64
    np.testing.assert_allclose(locations.loc[('TT', datetime.datetime(2021, 1, 1))], (9.055407, 48.515811))
    np.testing.assert_allclose(locations.loc[('KK', datetime.datetime(2021, 1, 1))], (6.958729, 50.943030))
